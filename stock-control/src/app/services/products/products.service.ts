...
export class ProductsService {
  ...
  createProduct(input:CreateProductRequest):Observable<CreateProductRequest>{
    return this.http.post<CreateProductRequest>(`${this.API_URL}/product`, input, this.httpOptions)
  }
}
